...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        // 사번/ 이름/ 주소/ 부서
        String emp1 = "100/홍길동/서울/영업부";       // 모든 값 존대
        String emp2 = "200/유관순//총무부";           // 주소 없음

        String[] empArr1 = emp1.split("/");         //기준은 슬러쉬(/)로 분리하겠다.
        ...
        {                       // token(구분자) 를 기준으로 출력, nextToken 있는 값을 출력한다.
            System.out.println("st2 : " + st1.nextToken());
