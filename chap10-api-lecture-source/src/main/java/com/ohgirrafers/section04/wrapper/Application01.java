package com.ohgirrafers.section04.wrapper;
...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *    Wrapper 클래스 라고 한다. (주방에서 사용하는 랩과 같이 감싼다는 의미이다.)
        * */
        ...
        *   기본타입을 래퍼클래의 인스턴스로 인스턴스화 하는 것을 Boxing 이라고 하며,
        *   래퍼클래스 타입의 인스턴스를 기본 타입으로 변경하는 것을 UnBoxing 이라고 한다.
        * */

        int intValue = 20;

        Integer boxingNumber1 = new Integer(intValue);       // 인스턴스화(박싱)_명시적 형변환

        int unBoxingNumber1 = boxingNumber1.intValue();     // 언박싱(intValue()) 이용

        Integer boxingNumber2 = intValue;                   // 오토 박싱(자동으로 형변환 해준다)
        ...
        System.out.println("integer 와 integer 비교 : " + (integerNum3 == integerNum2));

        /* 필기. 레퍼런스 타입의 인스턴스를 비교할 때는 equals() 를 사용해야 한다. */
